...
__UG_FONT_DATA unsigned char font_32x53[128][212]={
...
{
   gui->font = *font;
//   log_printf("Set H %d W %d\n", gui->font.char_height, gui->font.char_width);
...
//      log_printf ("fg %d, bg %d\n", gui->fore_color, gui->back_color);
